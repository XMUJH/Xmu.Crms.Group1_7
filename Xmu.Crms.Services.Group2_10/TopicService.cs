...
namespace Xmu.Crms.Services.Group2_10
{
    public class TopicService : ITopicService
    {
        ...
        public void UpdateTopicByTopicId(long topicId, Topic topic)
        {
            ...
            if (topic.GroupStudentLimit != 0) topicToUpdate.GroupNumberLimit = topic.GroupNumberLimit;
            if (topic.GroupStudentLimit != 0) topicToUpdate.GroupStudentLimit = topic.GroupStudentLimit;
